...
const FruitBoard = () => {
  ...
  // 수정된 게시글 저장
  const updateBoard = () => {
    const updatedBoardList = boardList.map(
      (
        b // 게시물에서 수정된 번호를 찾아 게시글제목과 설명을 저장
      ) =>
        b.no === editNo
      ...
      <div className="container" style={{ marginTop: "40px" }}>
        <div id="left_side">
          ...
          <ul>
            ...
            <li>
              <button class="inquiry-button">
                자주하는 질문<strong>&gt;</strong>
              </button>
            </li>
            <li>
              <button class="inquiry-button">
                1:1 문의<strong>&gt;</strong>
              </button>
            </li>
          </ul>
          <button>
            도움이 필요하신가요?<p>1:1문의하기</p>
            <strong>&gt;</strong>
          </button>
        </div>
